...
<div class="container">
    <div class="row">
        <div class="col-md-12">
               ...
               <h1>Edit  Slide</h1>
                ...
                <div>
                    <form novalidate="novalidate" class="form-horizontal" method="POST"  action="/homeslider/{{$homeslider->id}}/{{$homeslide->id}}/edit" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input id="title" type="text" class="form-control" name="title" value="{{ $homeslide->title }}" required autofocus>
                        ...
                        <div class="form-group{{ $errors->has('program_scheme') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                            <select class="form-control" id="type" name="program_scheme"  value="{{ $homeslide->program_schem }}" required>
    ...
    <option value="neela_s_retirement">Neela's Retirement</option>
                        ...
                        <div class="form-group{{ $errors->has('intro') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <textarea id="body" type="text" class="form-control" name="intro" rows="3" required> {!! $homeslide->intro !!}</textarea>
                        ...
                        <div class="form-group{{ $errors->has('body') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <textarea id="body" type="text" class="form-control" name="body" rows="20" required> {!! $homeslide->body !!}</textarea>
                        ...
                        <div class="form-group{{ $errors->has('filename') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input id="photos" type="file" class="form-control" name="filename"  value="{{ $homeslide->filename }}" required> 
                         ...
                         <div class="form-group{{ $errors->has('video') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input  type="text" class="form-control" name="video"  value="{{ $homeslide->video }}" required> 
                        ...
                        <div class="form-group{{ $errors->has('tagline') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-12">
                                <input  type="text" class="form-control" name="tagline"  value="{{ $homeslide->tagline }}" required> 
